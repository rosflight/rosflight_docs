...
!!! danger
  ...
  2. Set torque offsets as described in the [RC trim calculation](improving-performance.md#rc-trim) section of the Improving Performance page
  3. Tune the controller gains as described in the [Multirotor gain tuning](improving-performance.md#gain-tuning) section of the Improving Performance page
