...
!!! warning "ROSflight architecture"
    This page will not go over the [ROScopter](./roscopter/index.md)/[ROSplane](./rosplane/index.md)/[ROSflight firmware](../developer-guide/firmware/code-architecture.md) architecture, but we do reference it.
