...
If using a multirotor, follow the [ROScopter setup guide](../tutorials/setting-up-roscopter-in-sim.md) to get started.
If using a fixed-wing, follow the [ROSplane setup guide](../tutorials/setting-up-rosplane-in-sim.md).
